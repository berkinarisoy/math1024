...
\newcommand{\limseq}{\lim\limits_{n\to\infty}}
...
\fancyhead[L]{\hyperref[sec:contents]{\small MATH 1024}}
...
\title{Lecture Notes for MATH 1024\\ Honors Calculus II \\[1em]
\normalsize The Hong Kong University of Science and Technology}
...
\input{Sections/JordanMeasure.tex}
\input{Sections/Integration.tex}
\input{Sections/NumericalIntegration.tex}
